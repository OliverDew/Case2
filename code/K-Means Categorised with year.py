...
df_cluster = (
    df_net_cereals
    .groupby('country_or_area')[['net_imports', 'net_export', 'net_usd', 'year']]
    .mean()
    .reset_index())
...
X_scaled = scaler.fit_transform(
    df_cluster[['net_imports', 'net_export', 'net_usd', 'year']])
...
centroids = pd.DataFrame(
    ...
    columns=['net_imports', 'net_export', 'net_usd', 'year'])
...
cluster_summary = (
    df_cluster
    .groupby('cluster')[['net_imports', 'net_export', 'net_usd', 'year']]
    .mean())
